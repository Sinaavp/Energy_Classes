...
if uploaded_file is not None:
    ...
    def comfort(df):
        ...
        for month in months:
            ...
            fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(20, 1))
            ...
            if all(size != 0 for size in [class_a_percentage, class_b_percentage, class_c_percentage]):
                ...
                bars = ax1.barh(class_a_percentage, label='Class A', color='blue')
                bars = ax1.barh(class_b_percentage, left=class_a_percentage, label='Class B', color='orange')
                bars = ax1.barh(class_c_percentage, left=class_a_percentage + class_b_percentage, label='Class C', color='green')
                ax1.set_xlabel('Comfort classes')
                ax1.set_title('EN 15251 COMFORT HOURS - {}'.format(month))
                ax1.legend() 
                ax1.text(15,-2, f'{class_a_percentage:.1f}%', ha='center', va='center', color='black', fontsize=12, weight='bold')
                ax1.text((class_a_percentage + class_b_percentage), month, f'{class_b_percentage:.1f}%', ha='center', va='center', color='black', fontsize=12, weight='bold')
                ax1.text((class_a_percentage + class_b_percentage + class_c_percentage), month, f'{class_c_percentage:.1f}%', ha='center', va='center', color='black', fontsize=12, weight='bold')
