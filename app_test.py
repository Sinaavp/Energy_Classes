    ...
    def comfort(df):
        ...
        for month in months:
            ...
            if all(size != 0 for size in [class_a_percentage, class_b_percentage, class_c_percentage]):
                ...
                bars = ax1.barh(month, class_b_percentage, left=class_a_percentage, label='Class B', color='orange')
                ...
                ax1.legend() 
                ax1.text(class_a_percentage / 2, month, f'{class_a_percentage:.1f}%', ha='center', va='center', color='white', fontsize=12, weight='bold')
                ax1.text((class_a_percentage + class_b_percentage) / 2, month, f'{class_b_percentage:.1f}%', ha='center', va='center', color='white', fontsize=12, weight='bold')
                ax1.text((class_a_percentage + class_b_percentage + class_c_percentage) / 2, month, f'{class_c_percentage:.1f}%', ha='center', va='center', color='white', fontsize=12, weight='bold')
